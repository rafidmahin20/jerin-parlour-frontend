...
const Testimonials = () => {
    return (
        ...
        <div className="text-center md:max-w-xl lg:max-w-3xl mx-auto">
          ...
          The high-quality services and achievements haven't been bound to its 11 ladies beauty outlets only, but have expanded and reached out to receive an opportunity to serve the men though the 6 Menz outlets too.
          </p>
        </div>
